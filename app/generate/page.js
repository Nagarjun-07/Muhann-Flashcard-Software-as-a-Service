...
return (<Container maxWidth="md">
                       ...
                       <Card>  
                        <CardActionArea onClick={()=>{handleCardClick(index)}}>
                            ...
                            boxSizing: 'border-box',
                                ...
                                <div>
                                    <div><Typography variant="h5" component="div">{flashcard.front}</Typography></div><div><Typography variant="h5" component="div">{flashcard.back}</Typography></div></div></Box></CardContent>
                        </CardActionArea>
                        </Card>                  
                    </Grid>
                ))}
    ...
    <Dialog open={open} onClose={handleClose}>
        ...
        <DialogContentText> Please enter a name for your flashcards collection.</DialogContentText>
            <TextField autoFocus margin="denis" label="Collection Name" type="text" fullWidth value={name} onChange={(e)=>setName(e.target.value)} variant="outlined"/>
                <DialogContent>
                    <DialogActions>
